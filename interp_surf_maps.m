...
%dirIn=[pwd '/diags_state/']; list0=dir([dirIn 'state_3d_set1*.data']);
dirIn=[pwd '/diags_trsp/']; list0=dir([dirIn 'trsp_3d_set1*.data']);
%dirIn=[pwd '/diags_ptr/']; list0=dir([dirIn 'ptr_3d_set1*.data']);
%dirIn=[pwd '/diags_gud/']; list0=dir([dirIn 'gud_3d_set1*.data']);
...
fld=fld(:,:,1:50:end).*repmat(mygrid.mskC(:,:,1),[1 1 nfld]);
%
